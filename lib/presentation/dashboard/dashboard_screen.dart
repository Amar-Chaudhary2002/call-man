...
class CallTrackingService {
  ...
  static CallTrackingService get instance => _instance ??= CallTrackingService._();

  CallTrackingService._();

  final StreamController<CallRecord> _callStateController = StreamController<CallRecord>.broadcast();
  final StreamController<List<CallRecord>> _callHistoryController = StreamController<List<CallRecord>>.broadcast();
  ...
  CallRecord _mapCallLogToRecord(CallLogEntry entry) {
    return CallRecord(
      ...
      duration: entry.duration == null ? null : Duration(seconds: entry.duration!),
          ...
          children: [
            ...
            Text(
              duration != null && duration!.isNotEmpty
                  ...
                  : callType,
              style: TextStyle(
                color: callType.toLowerCase().contains("missed") ||
